...
Stand: **220 Guides, 21 Sektionen, 88 Endpunkte** (Blöcke 1–129 erledigt; Block 129 = 5 neue Guides, 2026-07-29; **Manifest v1.4.1, Baseline `0xf5ff3a29…ebc4` unberührt; Sweep-Workflow: Guides werden im privaten `crypto-knowledge-content`-Repo gepflegt, siehe Block-109-Eintrag; Philipp-Auftrag "mind. 5 nützliche Guides + 8 Endpunkte" komplett erfüllt (Block 128 Endpunkte + Block 129 Guides)**).

### Block 129 (2026-07-29) — 5 neue Guides (Philipp-Auftrag, zweiter Teil)

215→220 Guides, alle live verifiziert bevor Einbau: **chainlink_vrf_v2_5** (Subscription-Modell, VRFConsumerBaseV2Plus, Coordinator v2.5 0xD7f86b4b… eth_getCode-Bytecode bestätigt), **erc2771_meta_transactions** (EIP-Status "Final" direkt aus raw ERC-Text verifiziert, abi.encodePacked(data,from)-Mechanik, _msgSender()-Pattern), **nft_fractionalization** (ehrlicher Rahmen: Tessera/Fractional bestätigt eingestellt Mai 2023 — CoinDesk/The Block/nftnow, Repo seit 2022-12-17 tot, bei DeFiLlama nicht mehr gelistet — vs. aktuell aktives NFTX v3 auf Collection-statt-Einzel-NFT-Ebene, CreateVaultZap 0x56dab326… Bytecode + reales TVL via DeFiLlama bestätigt), **curve_convex_ve_tokenomics** (veCRV MAXTIME=4 Jahre/WEEK-Rundung/linearer Slope-Decay direkt aus VotingEscrow.vy verifiziert, GaugeController WEIGHT_VOTE_DELAY=10 Tage + 10000-Basispunkte-System verifiziert, Convex cvxCRV/vlCVX-Bündelungsmechanik aus dem aktiven convex-eth/platform-README), **eigenlayer_slashing_mechanism** (AllocationManager-Mechanik direkt aus offizieller Layr-Labs-Doku: Magnitude-Allocation, 3 Slashable-Bedingungen, slashOperator()-Ablauf, Race-Condition-Edge-Case; ALLOCATION_CONFIGURATION_DELAY=126000 Blocks aus mainnet.json verifiziert; Repo aktiv, v1.13.0 "Slash Resolution Delay" released 2026-06-25).

Vault-Sync: Smart-Contract-Entwicklung (EVM).md +2 (18→20 Guides, chainlink_vrf_v2_5+erc2771_meta_transactions), NFTs-Metadaten.md +1 (9→10, nft_fractionalization), DeFi-Lending.md +2 (20→22, curve_convex_ve_tokenomics+eigenlayer_slashing_mechanism) — alle mit TOC-Eintrag + Datum-Bump. MOC (Web3 Wissen.md) + Praxis-Referenz.md Zähler 215→220 gebumpt. references.ts GUIDE_SECTIONS: neue Topic-IDs in "Contract development (code)"+"Signing & auth"+"NFTs"+"Market, DeFi & social data"+"Staking" eingetragen. about.html + llms.txt (Coding/DeFi-Absätze) aktualisiert. tsc grün, vitest 91 passed (pubkey.test.ts vorbestehender ESM/CJS-Fehler unverändert). Baseline unberührt.
