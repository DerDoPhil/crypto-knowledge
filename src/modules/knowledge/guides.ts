...
export const GUIDES: Record<string, Guide> = {
  ...
  famous_nft_collections: {
    ...
    steps: [
      ...
      { title: "CryptoPunks (2017, Larva Labs)", note: "WEBSITE: cryptopunks.app (Yuga Labs) + larvalabs.com/cryptopunks (original). VERIFIED on-chain 2026-07: name()=CRYPTOPUNKS, symbol()=Ͼ (punk glyph), totalSupply()=10000, no ERC-2981. Contract 0xb47e3cd837ddf8e4c57f05d70ab865de6e193bbb (custom, PRE-dates ERC-721 — no standard transfer/approve!). 10k 24x24. The 2021 on-chain data lives in a SEPARATE contract: CryptoPunksData 0x16F5A35647D6F03D5D3da7b35409D65ba03aF3B2 — punkImageSvg(uint16) + punkAttributes(uint16) are gas-free views (live-verified: punkAttributes(0) returns 'Female 2, Earring, Blonde Bob, Green Eye Shadow'). For Seaport/ERC-721 composability use WrappedPunks 0xb7F7F6C52F2e2fdb1963Eab30438024864c313F6 (name()=='Wrapped Cryptopunks', on-chain verified). Source: github.com/larvalabs/cryptopunks (original market + ABI) and github.com/cryptopunksnotdead/punks.contracts (data/SVG/wrapper contracts documented). IP later moved to Yuga then Infinite Node Foundation. Deterministic forever." },
      { title: "BAYC (2021, Yuga Labs)", note: "WEBSITE: boredapeyachtclub.com. VERIFIED on-chain 2026-07: name()=BoredApeYachtClub, symbol()=BAYC, totalSupply()=10000, no ERC-2981 (royalties off-chain/registry). Contract 0xbc4ca0eda7647a8ab7c2061c2e118a18a936f13d. 10k. ipfs://QmeSjSinHpPnmXmspMjwiXyN6zS4E9zccariGR3jxcaWtq/{id}. On-chain provenance hash. Classic standard ERC-721 + IPFS. Large ecosystem (ApeCoin, Otherside); the ApeCoin staking contracts are open-source at github.com/HorizenLabs/ape-staking-public (BAYC/MAYC/BAKC pools — query staked positions for holder analysis)." },
      { title: "Milady Maker (Aug 2021, Remilia Corp)", note: "WEBSITE: miladymaker.net. VERIFIED on-chain 2026-07: name()=Milady, symbol()=MIL, totalSupply()=10000, no ERC-2981. Contract 0x5af0d9827e0c53e4799bb226655a1de152a425a5. 10k neochibi (Tokyo styles). Drip Score (aesthetic coherence, not pure rarity). Strong post-authorship culture, memes (Elon, Vitalik PFP), 'post-cancelled' lore. Copyleft elements. Companion = Remilio." },
      { title: "Remilio Babies (2022, Remilia)", note: "WEBSITE: remilio.org. VERIFIED on-chain 2026-07: totalSupply()=10000, but name()='TEST NFT' / symbol()='TEST' — Remilia never renamed the contract (known quirk; do not rely on name() for identification, use the address). Contract 0xd3d9ddd0cf0a5f0bfb8f7fceae075df687eaebab. 10k 'zoomer little brother' neochibi. Deeply tied to Milady cultural universe." },
      { title: "Azuki (Jan 2022, Chiru Labs)", note: "WEBSITE: azuki.com. VERIFIED on-chain 2026-07: name()=Azuki, symbol()=AZUKI, totalSupply()=10000. Contract 0xed5af388653567af2f388e6224dc7c4b3241c544. 10k anime. Big brand play: Elementals, AnimeChain L3, Bobu governance token experiment. Lasting technical legacy: ERC721A (github.com/chiru-labs/ERC721A, 2.5k stars) — the gas-efficient batch-mint ERC-721 implementation that became the default for trait-PFP launches (classic_trait_pfp_launch)." },
      { title: "Pudgy Penguins (2021, acquired by Luca Netz/Igloo 2022)", note: "WEBSITE: pudgypenguins.com. VERIFIED on-chain 2026-07: name()=PudgyPenguins, symbol()=PPG, totalSupply()=8888. Original 0xbd3531da5cf5857e7cfaa92426877b022e612cf8 (8888). Best real-world IP success via physical toys/merch with holder royalties. PENGU token on Solana: mint 2zMMhcVQEXDtdE6vsFS7S7D5oUodfJHE8vd1gnBouauv (symbol PENGU, 6 decimals — verified via Jupiter token API). Abstract Chain efforts." },
      { title: "Moonbirds (2022, PROOF Collective)", note: "WEBSITE: moonbirds.xyz. VERIFIED on-chain 2026-07: name()=Moonbirds, symbol()=MOONBIRD, totalSupply()=10000, ERC-2981=yes. Contract 0x23581767a106ae21c074b2276d25e5c3e136a68b. 10k. Nesting utility. CC0 license + later ecosystem moves." },
      { title: "Normies (Serc, 2026) — full on-chain, living state, burn-to-edit, ERC-8004 agents", note: "WEBSITE: normies.art (mint/hub) + rarity.normies.art (rarity explorer) + canvas.normies.art (burn-to-edit editor) + api.normies.art (public API + /llms.txt docs). STANDARD: ERC-721C (Limit Break creator token, programmable royalties) + ERC-2981 (on-chain verified: supportsInterface 0x80ac58cd & 0x2a55205a = true; NOT Enumerable). name()=Normies, symbol()=NORMIES. SUPPLY: maxSupply()=10000 (on-chain), IDs 0-9999; live supply 7355 (totalSupply, 2026-07), 2645 burned via burn-to-edit/zombie; floor ~0.40 ETH; 1250 tokens awakened as agents. CONTRACTS (Ethereum Mainnet, all live-verified to have code): Token 0x9Eb6E2025B64f340691e424b7fe7022fFDE12438 (owner 0x4b6314d2c8e28f2628901e775f7a5e0be32953f6) | NormiesStorage 0x1B976bAf51cF51F0e369C070d47FBc47A706e602 (SSTORE2 bitmap+traits, XOR-encoded) | Renderers V1 0xBe57fC4D0c729b8e8d33b638Dd441F57365e4c25 / V2 0x7818f24d3239c945510e0a1a523dd9971812c6c0 / V3 0x1af01b902256d77cf9499a14ef4e494897380b05 (RLE SVG + Pixel Count) / V4 0x8eC46Cc1f306652868a4dfbAAae87CBa2715A0eB (canvas-aware) / V5 0x7c726f02C5e840e1656b522A5C22caaf87C1C35C (zombie art) | Minter V1 0xC74994dD70FFb621CC514cE18a4F6F52124e296d / V2 0xc513272597d3022D77b3d7EEBA92cea5D7fb2808 (delegate.xyz v1/v2 cold-wallet delegation) | Canvas 0x64951d92e345C50381267380e2975f66810E869c (burn-to-edit orchestrator, owner 0xf65d6cf12ae3501ab025c529778f3a8edd85bc9d) + CanvasStorage 0xC255BE0983776BAB027a156681b6925cde47B2D1 | Zombie 0x18533ad55a54c3847Da06A48b51aD7DcB2551202 (Merkle-gated commit-reveal converter) + ZombieStorage 0xA331bD22C90D1DA096934Db8bc6b69F0e1491E26 | LegendaryCanvas 0xfA55f6592522dA74224a67c7D3Fd1DF759c628e8. API: api.normies.art keyless public GET, Ponder-indexed, full machine-readable ref at /llms.txt (~60 endpoints). Families: /normie/{id}/* (owner, pixels 1600-char 0/1 string, traits, metadata, image.svg|png, original/*, zombie/*, canvas/*) | /rarity/* (ranks, stats, traits, holder, historical/{block}/*, listings/stream SSE) | /history/* (burns, versions, customized feed) | /zombies/* | /agents/* (ERC-8004 metadata, A2A agent-card, binding) | /holders/{addr} | /canvas/status | /legendary-canvas/* | /health. MECHANICS: 40x40 1-bit bitmap (1600 px, 200 bytes). Owners burn other Normies (commit-reveal) to earn Action Points then edit pixels via Canvas XOR overlay. Dynamic on-chain traits: Level, Action Points, Pixel Count, Customized. Merkle-gated Zombie conversion swaps art+traits. Legendary Canvas = curated artist tokens. ERC-8004: any Normie can awaken into an on-chain AI agent (persona derived from traits, A2A agent-card, agent-id binding). Strongest full-on-chain + living-state design on Ethereum." },
      { title: "Bitfauna (DerDoPhil, 2026) — full on-chain 2-bit, editable, Solana Anchor + mpl-core", note: "WEBSITE: bitfauna.art ('BITFAUNA: 2-Bit On-Chain Pareidolia') + api.bitfauna.art (public API). STANDARD: Solana; Anchor program (bitfauna_core, IDL at api.bitfauna.art/api/idl) + Metaplex Core (mpl-core) NFTs. Collection name=Bitfauna, symbol=BTFN. SUPPLY: 1111, minted 56 (2026-07, /api/mint/status). ADDRESSES (Solana Mainnet, all live-verified on-chain): Program EQkRJkgLqNQkS4hJKieeTFpW6mAbFDKQpagj2PFZ2mzw (executable, BPFLoaderUpgradeable) | Collection 47Vb8QuNLrhkMr9qJRrFRXYpi4WcMfht5eMJ6RPtA2iP (owned by mpl-core CoREENxT6tW1HoK8ypY1SxRMZTcVPm7R94rH4PZNhX7d) | Config PDA CPSsSXBUzhzkdfzeWZSa7KhgFwG1k7fKVnE6d3Xvwnqq | TraitsStore PDA BqhCih7zrhcjTSpkP8FwXqn3KZDWkpZuHgbErzEK1DMZ | Authority 5gRLuBYyB7KXKef1NaTvRa4sS125j19Xio9mzjgxsd4B | PixelAccount PDA = seeds ['pixels', asset] (LAZY: created on first edit_pixels, saves rent). API: api.bitfauna.art keyless. GET /api/mint/status ({minted,total:1111}) | /api/mint/wallet-count | /api/collection-metadata | /api/metadata/{assetPubkey} | /api/image/{assetPubkey} | /api/assets-by-owner | /api/idl (Anchor IDL) | /api/banner | /api/refresh; POST /api/mint/prepare|broadcast|confirm (unsigned-tx mint flow). MECHANICS: 40x40 grid, 2-bit depth = 1600 px = exactly 400 bytes stored in PDAs. 4-color on-chain palette: White #FFFFFF, Black #000000, Gray #808080, Blue #0000FF (rarest 'Spark'). On-chain traits (Color, Pixel Count, Action Points, Edited flag). Anchor instructions: initialize, load_traits, create_asset, edit_pixels, burn_for_ap (burn an NFT to earn Action Points for more pixels). 100% full on-chain, no IPFS, no server. 'Digital evolution in 2 bits'." },
      { title: "Blupets (2026) — on-chain art, VRF evolution + merge genealogy (Ethereum)", note: "WEBSITE: blupix.app (BluKit builder API + explorer). Blurena (blurena.vercel.app, DerDoPhil) is a 3v3 battle game built on top of these NFTs. STANDARD: ERC-721 + ERC-2981 (on-chain verified). name()=Blupets, symbol()=BLUPET. SUPPLY: 8192 max, live 6804 (totalSupply 2026-07); minted via OpenSea SeaDrop. CONTRACTS (Ethereum Mainnet chain 1, all live-verified to have code): Core 0x52f7cA34F44A1d22F470253A06Af5110c7cfa05B (ERC-721, ownership + token state + lock, owner 0x26dd4199269bec9457f84adb029db917a910c711) | Renderer 0x5A07b2F30eca6F37712D8034CdDC9899Cb191D34 (SVG/metadata) | Descriptor 0x60d921853b447d1ee3e1E1f91821B01f087dADb5 (labels/traits/form) | ArtStorage 0xdaF33fB8095a521b6Ee3b0df2708606231c2cF6D (packed on-chain art) | Reveal Evolution 0xF420f0737B91EebF0561B7bfbdd78EB922a241a5 + Reveal VRFAdapter 0x54bb2b90b66e81f7d17b5769a2e57ed81cf788f2 | Merge Evolution 0x8E7880c9217fd4cB2219037dBD6E2454319Cf1a5 + Merge VRFAdapter 0xacBd37E6006620F3c7AA2Bf3550f2B8E05d402EB (Chainlink VRF consumer = the VRFAdapter, NOT the Evolution contract) | SeaDrop 0x00005EA00Ac477B1030CE78506496e8C2dE24bf5. API: blupix.app/api/blukit — keyless; docs at blupix.app/llms.txt + /blukit-guide.md + /api/blukit/openapi.json. GET /catalog (stages, lineages, forms), /vibes (64 vibes, VRF-assigned at T1 reveal), /token/{id} (stage, lineage, form, vibe, parentA/parentB, ancestry, mergeHistory, locked, pending, gender, artKey, onchainImage), /wallet/{addr} (indexed inventory), SVG/PNG renders. MECHANICS: 5 evolution stages T0-T4 (Mystery -> Base Color -> Pet Form -> Archetype -> Ascended). VRF reveal assigns vibe+lineage; Merge combines two Blupets into one with on-chain genealogy (parentA/parentB/ancestry/mergeHistory). Fully on-chain art via ArtStorage packed records + Renderer; Blupix/Supabase indexer for fast inventory. Close to Normies/Bitfauna in on-chain strength (on-chain art + living evolution state)." },
      { title: "Art Blocks generative (Fidenza example)", note: "WEBSITE: artblocks.io. VERIFIED on-chain 2026-07: flagship contract name()='Art Blocks', symbol()=BLOCKS, totalSupply()=198051 — this ONE contract holds ALL flagship projects; a token's projectId = tokenId / 1000000 (Fidenza is project 78). Platform 0xa7d8d9ef8d8ce8992df33d8b8cf4aebabd5bd270. Fidenza (Tyler Hobbs, 999). Generative script + params stored on-chain. Mint executes script. Highest on-chain strength for algorithmic art." },
      { title: "Other notables (Doodles, Nakamigos, GVC, Claynosaurz)", note: "WEBSITES: doodles.app | nakamigos.io | goodvibesclub.io | claynosaurz.com. VERIFIED on-chain 2026-07: Doodles 0x8a90CAb2b38dba80c64b7734e58Ee1dB38B8992e (name()=Doodles, symbol()=DOODLE, supply 10000; Burnt Toast + team, later DOOD token + programmable). Nakamigos 0xd774557b647330c91bf44cfeab205095f7e6c367 (name()=Nakamigos, symbol()=NKMGS, supply 20000, ERC-2981; 2023 custom). GVC 0xb8ea78fcacef50d41375e44e6814ebba36bb33c4 (name()='Good Vibes Club', symbol()=GVC, supply 6969, ERC-2981; Toast Studio + SuperRare, high-end art). Claynosaurz = Solana Metaplex (10k 3D dinos + game transmuter/eggs, Sui expansion; no EVM contract)." },
  ...
  robinhood_chain: {
    ...
    steps: [
      ...
      { title: "The token landscape (from the live explorer)", command: "GET https://robinhoodchain.blockscout.com/api/v2/tokens", note: "UPDATE 2026-07-22: equity tokens named '<Company> • Robinhood Token' (now NVDA, TSLA, AAPL, GOOGL, AMZN, MSFT, META, AMD, COIN, CRCL, MU, SNDK … plus tokenized ETFs SPY and SGOV, all 18 decimals) are NOT plain ERC-20s — every one is a BeaconProxy over a shared upgradeable 'Stock' implementation with mint/adminBurn/pause and a UI multiplier for splits (details + verification: robinhood_chain_dev). Plus stables (USDG 'Global Dollar' 6 dec, Ethena USDe) and a live memecoin/DeFi scene. Uniswap, 1inch, Lighter and Arcus deployed from day one — standard DeFi composability applies (aggregator_swaps, token_discovery)." },
  ...
  robinhood_chain_playbook: {
    ...
    steps: [
      ...
      { title: "Launch a token — the field is now CROWDED (updated day 21)", note: "UPDATE 2026-07-22 (Blockscout holder census): the empty-field window is GONE. CASHCAT is the #2 token overall at ~33k holders (behind only WETH), then TENDIES (~9.2k), HOODRAT (~8.6k), StonkBroker (~7.1k), YOLO, SLIPPY, DEGEN and more; native DeFi is live too (Sherwood Protocol/WOOD ~10k holders, Maple syrupUSDG). First-mover advantage is largely spent — edge shifts to quality/liquidity/distribution, not being first. Launch path stays plain EVM: deploy ERC-20 (deploy_erc20) → Factory.createPool(token, WETH, 3000) → NPM.mint(...) with initial liquidity → announce (token_launch_mechanics, sniping_launches from the OTHER side)." },
  ...
  solana_kit_web3js2: {
    topic: "solana_kit_web3js2",
    title: "The modern Solana TS stack: @solana/kit (web3.js v2), gill, Codama — and the 1.x migration traps",
    summary:
      "@solana/web3.js 1.x is in maintenance mode; its successor is @solana/kit (the renamed 'web3.js v2', maintained by Anza): tree-shakeable, functional, BigInt-native. The canonical Kit flow — createSolanaRpc, generateKeyPairSigner, pipe-built transaction messages, sendAndConfirmTransactionFactory — plus gill (higher-level wrapper), Codama (Anchor IDL → typed Kit clients) and the exact interop rules for Anchor and wallets. Versions, RPC calls and the full build/sign path live-executed against mainnet-beta 2026-07-21.",
    scope: ["solana"],
    prerequisites: ["Node 18+ in an ESM project (Kit is import-only)", "A funded keypair only if you actually send — build/sign needs none"],
    steps: [
      { title: "Install the modern package, not the old one", command: "npm i @solana/kit @solana-program/system   # NOT @solana/web3.js", note: "Verified 2026-07-21: @solana/kit latest = 7.0.0 (Anza, github.com/anza-xyz/kit). @solana/web3.js latest = 1.98.4 and its README says verbatim: 'This is the maintenance branch for the 1.x line… You can find the successor to this library here: @solana/kit.' The '@solana/web3.js@2.0.0' on the next tag is the pre-rename artifact — Kit is where development continues. Instruction builders live in separate @solana-program/* packages (system, token, compute-budget)." },
      { title: "Create the RPC client — there is NO Connection class", command: "import { createSolanaRpc } from '@solana/kit';\nconst rpc = createSolanaRpc('https://api.mainnet-beta.solana.com');\nconst slot = await rpc.getSlot().send();  // .send() is MANDATORY", note: "Live-verified: rpc.<method>() returns a pending request, not a Promise — forgetting .send() is the #1 trap (you get an object, not data). getBalance returns { context, value } — the number is under .value." },
      { title: "Everything numeric is a BigInt", command: "const { value } = await rpc.getBalance(address('EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v')).send();\n// typeof value === 'bigint'  (verified live: 515335920971n)", note: "getSlot, balance.value and getLatestBlockhash().value.lastValidBlockHeight are ALL bigint (1.x used number). Mixing bigint with number ('value + 1') throws 'Cannot mix BigInt and other types' — use 1_000_000n literals throughout." },
      { title: "Create a signer — generateKeyPairSigner is async", command: "import { generateKeyPairSigner, address, lamports } from '@solana/kit';\nconst signer = await generateKeyPairSigner();  // signer.address, signer.signMessages", note: "Kit wraps a non-extractable WebCrypto CryptoKey (no raw secret key exposed by default). address('…') and lamports(…n) are branded-type constructors replacing new PublicKey(...) / raw numbers — runtime-validated, compile-time-typed." },
      { title: "Get a blockhash lifetime", command: "const { value: latestBlockhash } = await rpc.getLatestBlockhash().send();", note: "Feed the whole { blockhash, lastValidBlockHeight } object into setTransactionMessageLifetimeUsingBlockhash — the lifetime becomes part of the message TYPE, so the compiler stops you sending a message without one." },
      { title: "Build the transaction message functionally with pipe()", command: "import { pipe, createTransactionMessage, setTransactionMessageFeePayerSigner, setTransactionMessageLifetimeUsingBlockhash, appendTransactionMessageInstruction } from '@solana/kit';\nimport { getTransferSolInstruction } from '@solana-program/system';\nconst message = pipe(\n  createTransactionMessage({ version: 0 }),\n  m => setTransactionMessageFeePayerSigner(signer, m),\n  m => setTransactionMessageLifetimeUsingBlockhash(latestBlockhash, m),\n  m => appendTransactionMessageInstruction(getTransferSolInstruction({ source: signer, destination: address(dest), amount: lamports(1_000_000n) }), m),\n);", note: "Live-verified end-to-end. Messages are IMMUTABLE — every setter returns a NEW object (unlike 1.x Transaction.add()). There is no SystemProgram.transfer — builders come from @solana-program/* (Codama-generated) and take named accounts/args." },
      { title: "Sign — signTransactionMessageWithSigners is async", command: "import { signTransactionMessageWithSigners, getSignatureFromTransaction } from '@solana/kit';\nconst signedTx = await signTransactionMessageWithSigners(message);\nconst sig = getSignatureFromTransaction(signedTx);  // base58 signature", note: "Collects every signer referenced in the message (fee payer + instruction signers) automatically — no manual key wiring." },
      { title: "Send + confirm via a factory (RPC + subscriptions)", command: "import { createSolanaRpcSubscriptions, sendAndConfirmTransactionFactory } from '@solana/kit';\nconst rpcSubscriptions = createSolanaRpcSubscriptions('wss://api.mainnet-beta.solana.com');\nconst sendAndConfirm = sendAndConfirmTransactionFactory({ rpc, rpcSubscriptions });\nawait sendAndConfirm(signedTx, { commitment: 'confirmed' });", note: "Confirmation is push-based over WebSocket (separate object from the HTTP rpc) — no 1.x polling loop. Throws on failure, resolves on confirmation." },
      { title: "Compute budget: the Kit way", command: "import { estimateComputeUnitLimitFactory, setTransactionMessageComputeUnitLimit, setTransactionMessageComputeUnitPrice } from '@solana/kit';", note: "Replaces 1.x ComputeBudgetProgram. estimateComputeUnitLimitFactory({ rpc }) simulates to size the limit; setTransactionMessageComputeUnitPrice(microLamports, m) adds the priority fee (solana_priority_fees). Add as extra pipe() steps before signing. Export names verified; not exercised with a funded send." },
      { title: "Prefer gill when you want less boilerplate", command: "npm i gill\nimport { createSolanaClient } from 'gill';\nconst { rpc, rpcSubscriptions, sendAndConfirmTransaction } = createSolanaClient({ urlOrMoniker: 'mainnet' });", note: "gill (gillsdk.com) is built ON @solana/kit and re-exports its types: one createSolanaClient call replaces the rpc+subscriptions+sendAndConfirm wiring, plus createTransaction/getExplorerLink/lamportsToSol; gill/node adds loadKeypairSignerFromFile/loadKeypairSignerFromEnvironment (the Node file loaders Kit omits). Live-verified: rpc.getSlot() → bigint slot." },
      { title: "Generate a typed client from an Anchor IDL with Codama", command: "npm i codama @codama/nodes-from-anchor && npx codama init   # writes codama.json pointing at target/idl/my_program.json\nnpx codama run js", note: "codama 1.9.0 (verified). Auto-detects Anchor IDLs; @codama/renderers-js emits a Kit-compatible client (getXInstruction builders, account decoders) — the same way @solana-program/* packages are generated. This is how you call an Anchor program from Kit code WITHOUT @coral-xyz/anchor." },
      { title: "Interop with existing Anchor / web3.js 1.x code", command: "import { fromLegacyPublicKey, fromLegacyKeypair, fromVersionedTransaction, fromLegacyTransactionInstruction } from '@solana/compat';", note: "Verified: @coral-xyz/anchor 0.32.1 still depends on @solana/web3.js ^1.69.0 — the Anchor TS client is a 1.x world. @solana/compat converts one-directionally legacy → Kit. For greenfield code, generate a Kit client via Codama instead of bridging." },
      { title: "Wallets: wallet-adapter is 1.x — use @solana/react for Kit", command: "npm i @solana/react\nimport { useWalletAccountTransactionSendingSigner } from '@solana/react';", note: "Verified: @solana/wallet-adapter-base peer-depends on @solana/web3.js ^1.98.0 (1.x-bound). The Kit-native path is @solana/react (versioned in lockstep with Kit) over Wallet Standard — its hooks adapt a UiWalletAccount into Kit signers you drop into setTransactionMessageFeePayerSigner." },
    ],
    warnings: [
      "Do NOT `npm i @solana/web3.js` for new work — that name is the 1.x maintenance line (1.98.4). The successor is @solana/kit (7.0.0). The '@solana/web3.js@2.0.0' next-tag is a pre-rename leftover.",
      "Every rpc.<method>(...) needs .send(), and every numeric result is a BigInt — 'value + 1' throws 'Cannot mix BigInt and other types'.",
      "Kit is ESM-first: require() paths throw ERR_PACKAGE_PATH_NOT_EXPORTED (hit live). Project must be ESM (type:module / .mjs / bundler). generateKeyPairSigner and signTransactionMessageWithSigners are async.",
      "gill 0.14.0 pins @solana/kit ^5.0.0 while Kit latest is 7.0.0 — installing both side by side can produce two Kit copies and cross-package type mismatches. Take Kit types from gill's re-exports, or align majors.",
      "@coral-xyz/anchor (0.32.1) is still web3.js 1.x under the hood — you cannot hand Kit objects to Anchor's Program client directly; bridge with @solana/compat or go Codama.",
    ],
    references: ["https://www.solanakit.com", "https://github.com/anza-xyz/kit", "https://www.gillsdk.com", "https://github.com/codama-idl/codama", "https://solana.com/docs/clients/javascript"],
  },

  solana_program_testing: {
    topic: "solana_program_testing",
    title: "Test & CU-optimize Solana programs (LiteSVM, Mollusk, surfpool, Anchor)",
    summary:
      "The modern Solana test stack — pick the right runner (in-process SVM vs bare harness vs mainnet fork), measure compute units, and shrink them. bankrun is dead; LiteSVM is the successor. Versions + a full LiteSVM airdrop/transfer/CU run live-executed 2026-07-21 (CU for a System transfer: 150, measured twice independently).",
    scope: ["solana"],
    prerequisites: ["setup_dev_env (Rust + Anza CLI + Node 20)", "Anchor for the Anchor-specific steps"],
    steps: [
      { title: "Pick the runner by what you're trading off", note: "SPEED: Mollusk (bare SVM harness by Anza, no Bank/AccountsDB — fastest, but YOU supply every account explicitly). BALANCE: LiteSVM (in-process SVM with Bank semantics, sysvars, CPIs — the default for unit/integration tests, Rust + TS). REALISM/FORK: surfpool (drop-in solana-test-validator replacement that mirrors live mainnet state) or solana-test-validator (full local validator — slowest; only when you need real RPC/geyser behavior). solana-program-test/BanksClient still exists but LiteSVM wraps the same machinery faster." },
      { title: "LiteSVM TypeScript quickstart (verified to run)", command: "npm i litesvm @solana/kit @solana-program/system\nimport { LiteSVM } from 'litesvm';\nimport { generateKeyPairSigner, lamports, address, pipe, createTransactionMessage, setTransactionMessageFeePayerSigner, appendTransactionMessageInstruction, signTransactionMessageWithSigners } from '@solana/kit';\nimport { getTransferSolInstruction } from '@solana-program/system';\nconst svm = new LiteSVM();\nconst payer = await generateKeyPairSigner();\nsvm.airdrop(payer.address, lamports(1_000_000_000n));\nconst ix = getTransferSolInstruction({ source: payer, destination: address('…'), amount: lamports(1_000_000n) });\nconst msg = pipe(createTransactionMessage({ version: 0 }), m => setTransactionMessageFeePayerSigner(payer, m), m => svm.setTransactionMessageLifetimeUsingLatestBlockhash(m), m => appendTransactionMessageInstruction(ix, m));\nconst meta = svm.sendTransaction(await signTransactionMessageWithSigners(msg));", note: "No validator, no RPC, no airdrop wait — the whole SVM runs in your Node process. Load your program with svm.addProgramFromFile(programId, 'target/deploy/prog.so'). This exact script was executed live (litesvm 1.3.0): airdrop + transfer succeeded." },
      { title: "Measure compute units — the cheapest feedback loop", command: "const meta = svm.sendTransaction(tx);\nconsole.log(meta.computeUnitsConsumed().toString()); // → 150 for a System transfer (measured live)\nconsole.log(meta.logs());", note: "TransactionMetadata.computeUnitsConsumed() gives exact CU with zero network round-trips — assert on it in CI to catch regressions (like forge gas snapshots). For custom programs, meta.logs() prints 'Program <id> consumed X of Y compute units'." },
      { title: "LiteSVM in Rust (integration tests next to your program)", command: "// Cargo.toml [dev-dependencies]: litesvm = \"0.14\"\nuse litesvm::LiteSVM;\nlet mut svm = LiteSVM::new();\nsvm.add_program_from_file(program_id, \"target/deploy/prog.so\").unwrap();\nsvm.airdrop(&payer.pubkey(), 1_000_000_000).unwrap();\nlet res = svm.send_transaction(tx).unwrap();\nassert!(res.compute_units_consumed < 5_000);", note: "Same engine as the TS package. Rust tests add time-travel (svm.warp_to_slot, set_clock), sysvar overrides and setAccount for arbitrary state without sending txs." },
      { title: "Mollusk when raw CU numbers are the point", command: "// Cargo.toml: mollusk-svm = \"0.14\", mollusk-svm-bencher = \"0.14\"\nlet mollusk = Mollusk::new(&program_id, \"prog\");\nlet result = mollusk.process_instruction(&instruction, &accounts);\nMolluskComputeUnitBencher::new(mollusk).bench((\"transfer\", &ix, &accounts)).out_dir(\"target/benches\").execute();", note: "Mollusk (Anza) skips Bank/AccountsDB entirely — you pass the exact account list, it runs just the instruction. Fastest loop for CU tuning; the matrix bencher compares two implementations side by side. Trade-off: no automatic sysvars/rent/CPI convenience." },
      { title: "Anchor testing: the default `anchor test` flow", command: "anchor test   # builds, boots a local solana-test-validator, runs ts-mocha tests in tests/", note: "Realistic but validator boot dominates runtime. `anchor test --skip-build` / `--skip-deploy` to iterate faster on the same artifacts." },
      { title: "Anchor + LiteSVM: skip the validator entirely", command: "npm i anchor-litesvm\nimport { fromWorkspace, LiteSVMProvider } from 'anchor-litesvm';\nconst provider = new LiteSVMProvider(fromWorkspace('.'));\nconst program = new Program(idl, provider);\n// run with: anchor test --skip-local-validator", note: "anchor-litesvm (0.2.1) swaps AnchorProvider for a LiteSVM-backed provider — same Program API, no validator; documented in the official Anchor docs. Cuts suites from tens of seconds to sub-second. bankrun did this before but is deprecated (see warnings)." },
      { title: "Set the CU budget explicitly in a transaction", command: "import { getSetComputeUnitLimitInstruction, getSetComputeUnitPriceInstruction } from '@solana-program/compute-budget';\ngetSetComputeUnitLimitInstruction({ units: 30_000 });        // hard cap this tx\ngetSetComputeUnitPriceInstruction({ microLamports: 1_000n }); // priority fee", note: "Default budget = 200,000 CU per non-builtin instruction, hard max 1,400,000 CU per transaction. Set the LIMIT just above measured consumption so the tx schedules better and you don't overpay; the PRICE is the priority fee (solana_priority_fees)." },
      { title: "Measure CU against a real cluster (no LiteSVM)", command: "const sim = await rpc.simulateTransaction(tx, { replaceRecentBlockhash: true }).send();\nconsole.log(sim.value.unitsConsumed);\n# or stream: solana logs | grep consumed", note: "simulateTransaction.unitsConsumed is the canonical on-chain CU read — simulate, add ~10% headroom, set that as the SetComputeUnitLimit for the real send." },
      { title: "Cut CU: the high-leverage moves", note: "1) Drop msg!/logging in hot paths — string formatting is one of the biggest silent CU sinks (sol_log_data or nothing). 2) Zero-copy account access (Anchor #[account(zero_copy)] / bytemuck) instead of Borsh for large accounts. 3) Minimize CPIs and account loads. 4) Extreme end: write the program with Pinocchio (Anza, no_std, zero-copy entrypoint, crate 0.11.2) — removes serialization/allocation overhead. Re-measure after every change." },
      { title: "Respect the memory limits (they fail at runtime, not compile time)", note: "BPF stack frame = 4 KB per frame ('Access violation in stack frame' when deep calls / big stack locals overflow), heap = 32 KB default per instruction. Large fixed-size stack arrays are the usual culprit — box them or go zero-copy. A test exercising the big-input path is what catches this." },
      { title: "Fork mainnet state for realistic tests", command: "# Option A — surfpool (anvil-for-Solana): forks live mainnet accounts on demand\ncurl -sL https://run.surfpool.run/ | bash && surfpool start\n# Option B — LiteSVM with dumped accounts:\nsolana account <PUBKEY> --output json --output-file acct.json   # then svm.setAccount() in the test", note: "surfpool (v1.5.0, active) pulls real mainnet account state without a snapshot — the Solana analog of anvil --fork-url; test against live Jupiter/Kamino/Orca state. For a single dependency account, dumping + setAccount keeps the test hermetic and fast." },
    ],
    warnings: [
      "litesvm 1.x (TS) migrated to @solana/kit — passing a web3.js-1.x PublicKey to airdrop/getBalance throws 'value.split is not a function' (reproduced live). Use Kit Address strings (signer.address / address('…')); see solana_kit_web3js2.",
      "solana-bankrun / anchor-bankrun are DEPRECATED — the README says verbatim 'DEPRECATED: use LiteSVM instead' (same author). Don't start new suites on bankrun.",
      "Mollusk gives you NO automatic accounts — every account (incl. sysvars, PDAs) must be passed explicitly. Great for CU benchmarks, painful for integration flows (LiteSVM there).",
      "surfpool's crates.io entry is stale (0.1.0) — do NOT `cargo install surfpool`; install the maintained v1.5.x via the curl script or a release binary.",
      "LiteSVM's simulateTransaction().meta().computeUnitsConsumed() returned 0 in our live test while sendTransaction().computeUnitsConsumed() correctly returned 150 — measure CU from sendTransaction metadata in LiteSVM, use simulateTransaction.unitsConsumed only against a real RPC.",
      "'Tests green' on LiteSVM/Mollusk is not 'works on mainnet': no validator scheduling, fee markets, priority-fee inclusion or account-lock contention. Final pass on surfpool (forked state) or devnet before deploy.",
    ],
    references: ["https://www.litesvm.com/", "https://github.com/LiteSVM/litesvm", "https://github.com/anza-xyz/mollusk", "https://github.com/anza-xyz/pinocchio", "https://github.com/txtx/surfpool", "https://solana.com/docs/core/fees/compute-budget", "https://github.com/solana-developers/cu_optimizations"],
  },

  onchain_data_indexing: {
    topic: "onchain_data_indexing",
    title: "Index on-chain events into a queryable store (EVM + Solana): frameworks, polling, webhooks, streams",
    summary:
      "The layer ABOVE raw getLogs/getSignaturesForAddress (fetch_event_logs): turning event streams into a durable, reorg-safe, queryable dataset. When to use a framework (Ponder, The Graph, Envio) vs a hand-rolled poller vs a push webhook/gRPC stream, on both EVM and Solana. Framework versions, free-RPC getLogs limits and endpoint auth states live-verified 2026-07-21/22.",
    scope: ["evm", "solana"],
    prerequisites: ["fetch_event_logs (raw getLogs mechanics + topic0)", "A Postgres you control, OR a hosted indexer plan"],
    steps: [
      { title: "First decide the LAYER — this picks everything else", note: "Three shapes, in order of effort: (1) Hand-rolled poller (viem getLogs / getSignaturesForAddress + your own DB) — 1-few contracts, full control, no infra. (2) Indexing FRAMEWORK (Ponder / The Graph / Envio) — many contracts, joins/aggregations, GraphQL/SQL API, built-in reorg handling + backfill. (3) PUSH stream (Helius webhook, Yellowstone gRPC, EVM WebSocket) — low-latency 'react NOW', but NO historical backfill. Backfill and live are different problems: frameworks do both; webhooks/streams only do live." },
      { title: "Know the free-RPC getLogs reality before you build (EVM)", note: "MEASURED LIVE 2026-07-22 against USDC Transfer logs: publicnode (ethereum-rpc.publicnode.com) serves getLogs ONLY near head — a 50-block range returned 3363 logs, a 100-block range already fails with 'Archive requests require a personal token' (so any real backfill is impossible there). drpc free tier (eth.drpc.org): hard cap 'ranges over 10000 blocks are not supported on freetier' (error code 35). Backfilling a busy contract over free RPC = thousands of capped calls at ~10 req/s — this economics is exactly why HyperSync / subgraphs / Ponder-on-paid-RPC exist." },
      { title: "Lightweight EVM live: viem watchEvent (or getLogs poll) — with reorg safety", command: "const unwatch = client.watchEvent({ address, event: parseAbiItem('event Transfer(address indexed,address indexed,uint256)'), onLogs: (logs) => save(logs), pollingInterval: 4000 })", note: "watchEvent polls under the hood — it is NOT push. Reorg safety is YOUR job: only treat a log as final at (head − N) confirmations; store blockNumber + blockHash per row; if the stored hash at a height stops matching the RPC's, delete rows ≥ that height and re-fetch. viem sets removed: true when the node retracts a log — handle it. Cheap pattern: a 'safe' view up to head−N and an optimistic 'live' view above it." },
      { title: "Framework option A — Ponder (TypeScript, code-first, Postgres)", command: "npm create ponder@latest   # scaffolds ponder.config.ts + ponder.schema.ts; then: npm run dev", note: "ponder 0.17.1 (verified). createConfig({ chains: { mainnet: { id: 1, rpc: process.env.PONDER_RPC_URL_1 } }, contracts: { MyC: { abi, chain: 'mainnet', address, startBlock } } }); schema via onchainTable(); handlers ponder.on('MyC:Transfer', async ({ event, context }) => { await context.db.insert(…) }). Reorgs handled AUTOMATICALLY (docs: log.removed is always false — Ponder rolls back internally). Serves auto-generated GraphQL + direct SQL. Docs: most apps need a paid RPC plan to avoid rate limits." },
      { title: "Framework option B — The Graph subgraph (GraphQL, decentralized network)", command: "npm install -g @graphprotocol/graph-cli   # 0.98.1 verified\ngraph init && graph codegen && graph build && graph deploy <SLUG>", note: "The HOSTED SERVICE IS DEAD (shut down 2024-06-12) — old tutorials/endpoints are gone; only the decentralized network exists. Workflow: Subgraph Studio → deploy key → graph deploy → 'Publish' on-chain. Mappings are AssemblyScript. Cost: 100k free queries/month via gateway.thegraph.com API key, then per-query GRT fees. Heaviest ceremony of the three; pick it for public/decentralized data or an existing subgraph ecosystem." },
      { title: "Framework option C — Envio HyperIndex + HyperSync (fastest backfill)", command: "pnpx envio init   # 'Contract Import'; then: pnpm dev   (Docker required)", note: "envio 3.2.1 (verified). config.yaml: network id, start block, contract address, event signatures; handlers in TS. pnpm dev boots indexer + Hasura GraphQL over Docker/Postgres; reorgs handled internally. Speed comes from HyperSync, Envio's own data engine (docs claim up to ~2000x vs RPC). AUTH VERIFIED LIVE 2026-07-22: HyperSync is NOT keyless — GET eth.hypersync.xyz/height answers openly, but the actual data query (POST /query) returns 401 'Your token is malformed' without a token. Free-tier tokens at app.envio.dev/api-tokens; only Envio-Cloud-deployed indexers skip the token." },
      { title: "Framework option D — Substreams (parallelized, highest throughput)", note: "StreamingFast/The Graph's Rust-based massively-parallel model over Firehose block data; sinks into Postgres, a subgraph, or a stream (reported). Choose it for whole-chain analytics / very large backfills where Ponder/subgraphs are too slow AND you can afford the Rust learning curve + a Substreams provider. Overkill for a handful of contracts." },
      { title: "Solana baseline — getSignaturesForAddress + getTransaction polling", command: "curl https://api.mainnet-beta.solana.com -d '{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"getSignaturesForAddress\",\"params\":[\"<ADDR>\",{\"limit\":1000,\"before\":\"<sig>\"}]}'", note: "VERIFIED: limit max 1000 (limit 2000 → -32602 'Invalid limit; max 1000'); rows carry signature, slot, blockTime, err, confirmationStatus. Paginate BACKWARDS via before=oldest seen; set until=last indexed signature to stop. Hydrate with getTransaction({ maxSupportedTransactionVersion: 0 }). Reorg rule: only 'processed'/'confirmed' can drop — index at 'finalized' to be safe. The no-dependency Solana indexer; slow for hot accounts." },
      { title: "Solana live-lite — logsSubscribe WebSocket", command: "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"logsSubscribe\",\"params\":[{\"mentions\":[\"<ADDR>\"]},{\"commitment\":\"confirmed\"}]}", note: "Push of tx logs mentioning an address. Public mainnet WS is heavily rate-limited and drops connections under load (reported) — dev only. Logs only (still getTransaction to decode); no backfill — combine with the poller for gap-fill on reconnect." },
      { title: "Solana push — Helius webhooks (server-to-server HTTP)", command: "curl -X POST \"https://api.helius.xyz/v0/webhooks?api-key=<KEY>\" -d '{\"webhookURL\":\"https://you/hook\",\"transactionTypes\":[\"NFT_SALE\"],\"accountAddresses\":[\"<ADDR>\"],\"webhookType\":\"enhanced\"}'", note: "'enhanced' = Helius-parsed + filterable by transactionTypes; 'raw' = unparsed, lower latency. No polling, no socket. Pricing (reported): 1 credit per delivered event, 100 per webhook API op; free plan 1M credits/mo — but webhook availability on the FREE tier is not clearly documented, verify in your dashboard before relying on it." },
      { title: "Solana highest-throughput — Yellowstone / Geyser gRPC", note: "Yellowstone (rpcpool/yellowstone-grpc, 'Dragon's Mouth') is gRPC over the validator-side Geyser plugin: push stream of account updates, slots, txs, blocks. Provider-agnostic .proto (Rust/TS/Go) — switching provider is a URL+key swap. NO keyless endpoint — always paid/managed (Helius LaserStream gRPC = Business tier, Triton, QuickNode, Chainstack, Shyft — reported). For MEV/market-data-grade latency; overkill for ordinary indexing." },
      { title: "Architecture for an autonomous agent", note: "Backfill vs live are two jobs: load history ONCE (framework or bounded getLogs/getSignatures sweep), then a live tail (framework head, WS or webhook). Persist the last indexed (block, blockHash) / (slot, signature) as a cursor so restarts resume, not re-scan. Never act on money on unfinalized data — gate side-effects on head−N (EVM) / 'finalized' (Solana). A hand-rolled poller needs UNIQUE(txHash, logIndex) / UNIQUE(signature) so crash-reprocessing stays idempotent (error_taxonomy_retries; cost trade-offs: agent_cost_accounting)." },
    ],
    warnings: [
      "publicnode free tier serves getLogs only in a ~50–100 block window near head (measured live: 50 ok, 100 → 'Archive requests require a personal token'); drpc free caps ranges at 10,000 blocks (code 35). An indexer pointed at free RPC will crawl or fail — budget a paid/archive RPC or a data engine (HyperSync/subgraph) for any real backfill.",
      "HyperSync is NOT keyless (verified: POST /query → 401 without token; only GET /height is open). Free token at app.envio.dev/api-tokens; only Envio-Cloud deployments skip it.",
      "The Graph hosted service shut down 2024-06-12 — only the decentralized network exists; old hosted-service endpoints/tutorials are dead.",
      "Frameworks handle reorgs FOR you (Ponder/Envio built-in). A hand-rolled poller does NOT — track blockHash/slot and roll back, or index only finalized depth. 'Worked on a quiet testnet' hides this until the first mainnet reorg.",
      "Webhooks/gRPC streams deliver from NOW on — they cannot backfill. Every push design needs a separate backfill pass + gap-fill on reconnect, or it silently misses events during downtime.",
    ],
    references: ["https://ponder.sh/docs", "https://thegraph.com/docs/en/subgraphs/quick-start/", "https://docs.envio.dev/docs/HyperIndex/overview", "https://www.helius.dev/docs/webhooks", "https://github.com/rpcpool/yellowstone-grpc"],
  },

  robinhood_chain_dev: {
    topic: "robinhood_chain_dev",
    title: "Robinhood Chain for builders: deploy, verify, precompiles, and the Stock-token interface",
    summary:
      "The developer layer under robinhood_chain: the exact Foundry deploy+verify flow, the Arbitrum-Orbit precompiles that answer live, the real two-part fee model, and — critically — that Stock tokens are upgradeable BeaconProxies with a UI multiplier, NOT the plain ERC-20s they look like. All on-chain facts verified 2026-07-21/22 (chainId, precompiles, proxies, uiMultiplier re-derived by the lead reviewer).",
    scope: ["evm"],
    prerequisites: ["robinhood_chain (connection & basics)", "robinhood_chain_playbook (the DeFi map)"],
    steps: [
      { title: "Chain profile (live-measured 2026-07-21/22)", command: "POST https://rpc.mainnet.chain.robinhood.com {\"method\":\"web3_clientVersion\"} → nitro/v3.11.3-rc.4-…  |  eth_chainId → 0x1237 (4663)  |  ArbSys(0x64).arbOSVersion() → 116 (raw)", note: "Arbitrum Nitro (Orbit) stack, gas token ETH. Block time MEASURED ~0.10s/block (100k-block average, cross-checked against total blocks/age) — sequencer/traffic-driven, not fixed cadence. Block gasLimit is 2^50, so per-block gas is never your constraint. The RPC rejects clients without a User-Agent header." },
      { title: "Deploy with Foundry (official flow, permissionless)", command: "forge create HelloRobinhood --rpc-url https://rpc.mainnet.chain.robinhood.com --account myKey --broadcast", note: "Standard Nitro EVM — Foundry/Hardhat/viem work unmodified (docs.robinhood.com/chain/deploy-smart-contracts). Testnet: chainId 46630 (live-verified), RPC https://rpc.testnet.chain.robinhood.com/rpc, faucet https://faucet.testnet.chain.robinhood.com (testnet ETH + test Stock tokens). Robinhood seeded a $1M Arbitrum dev fund (reported)." },
      { title: "Verify contracts (Blockscout, keyless)", command: "forge verify-contract <addr> src/X.sol:X --chain-id 4663 --rpc-url $RH_RPC --verifier blockscout --verifier-url https://robinhoodchain.blockscout.com/api/", note: "No API key needed (Hardhat: set apiKey to any string). Blockscout also answers the Etherscan-compatible /api?module=contract&action=getabi route (live-verified status:1), so --verifier etherscan works too. Verification config (GET /api/v2/smart-contracts/verification/config): standard-input, flattened, multi-part, sourcify, Vyper; solc up to 0.8.36." },
      { title: "Arbitrum-Orbit precompiles that answer live", command: "eth_getCode(0x…0064) → 0xfe (precompile marker); ArbSys.arbChainID() → 4663; ArbGasInfo at 0x…006C", note: "ArbSys 0x0000000000000000000000000000000000000064 and ArbGasInfo 0x…006C are real code (0xfe). NodeInterface 0x…00C8 is VIRTUAL — eth_getCode returns 0x; it only exists for eth_call/gas estimation (gasEstimateComponents, gasEstimateL1Component). Don't check its code — call it." },
      { title: "The real fee model: two-part, L1 component small but NOT zero", command: "ArbGasInfo.getPricesInWei() → perArbGasTotal ~0.074 gwei; getL1BaseFeeEstimate() fluctuates (observed 0 AND ~0.0013 gwei across reads)", note: "Like Arbitrum One: L2 execution + an L1 data surcharge (settles to Ethereum). All-in gas ~0.07–0.09 gwei (Blockscout /api/v2/stats gas_prices, live). The L1 component fluctuates near zero — a single read can show 0, so NEVER hardcode it: use eth_estimateGas (includes the poster fee) or NodeInterface.gasEstimateL1Component. getMinimumGasPrice() = 0.02 gwei floor. Ordering is FCFS — no priority-fee auction." },
      { title: "Stock tokens are upgradeable BeaconProxies — not plain ERC-20s", command: "GET robinhoodchain.blockscout.com/api/v2/smart-contracts/0xd0601CE157Db5bdC3162BbaC2a2C8aF5320D9EEC → BeaconProxy (eip1967_beacon), impl 'Stock' 0xb35490d6f9163DE4F80d88dc75c3516eb64C5aE2", note: "EVERY Stock token (NVDA/AAPL/TSLA/… + ETFs SPY/SGOV) is a BeaconProxy over ONE shared Stock implementation — read it once to know all of them; a beacon upgrade changes all tokens at once. Beyond ERC-20 the ABI has: mint, adminBurn (issuer clawback), pause/unpause, pauseOracle, updateMultiplier, permit (ERC-2612), ACCESS_CONTROLLED_REGISTRY() → 0xe10b6f6b275de231345c20d14ab812db62151b00. These are issuer-controlled RWAs — treat freeze/clawback as live risks." },
      { title: "THE gotcha: the UI multiplier (balanceOf ≠ displayed shares)", command: "uiMultiplier() (selector 0xa60bf13d) on NVDA → 1e18 (=1.0x, live-verified twice)  |  balanceOfUI = balanceOf × uiMultiplier / 1e18", note: "Stock tokens carry a WAD multiplier for corporate actions (splits/reverse splits). balanceOf()/totalSupply() are RAW base units; balanceOfUI()/totalSupplyUI() apply the multiplier. Today 1.0 — but a split flips this and raw-value share math breaks. Watch events TransferWithScaledUI and UIMultiplierUpdated (effectiveAt). DEX pools trade the RAW token, so an on-chain split can reprice pools. Legal terms on-chain: terms() → https://robinhood.com/stocktoken/<uid>." },
      { title: "Gasless approvals work (ERC-2612 permit)", note: "Stock tokens AND USDG expose permit()/nonces()/DOMAIN_SEPARATOR() (verified in the ABIs) — signature-based approvals, no separate approve tx (permit2_usage for the Uniswap-style alternative; Permit2 is at its canonical address here)." },
      { title: "Bridging in/out (canonical dev path)", note: "Official route: the Arbitrum bridge (bridge.arbitrum.io, Robinhood Chain as destination; parent chain Ethereum, testnet parent Sepolia). Standard retryable-ticket mechanics (ArbRetryableTx precompile); NodeInterface for L1→L2 gas estimation. LayerZero is the announced omnichain partner (reported). The L1 settlement contracts live on Ethereum — not queryable from this RPC." },
      { title: "Pin canonical token addresses (all live-verified via symbol()/decimals())", command: "WETH 0x0Bd7D308f8E1639FAb988df18A8011f41EAcAD73 (18) | USDG 0x5fc5360D0400a0Fd4f2af552ADD042D716F1d168 (6!) | USDe 0x5d3a1Ff2b6BAb83b63cd9AD0787074081a52ef34 (18) | syrupUSDG 0x40858070814a57FdF33a613ae84fE0a8b4a874f7 (6)", note: "Stock tokens are all 18 decimals; USDG (Global Dollar, the dominant stablecoin here) is 6. Resolve everything from getters — mainnet muscle memory is wrong on this chain (only Permit2/Multicall3 are canonical)." },
      { title: "Oracle layer: Chainlink (partner) — verify feeds before wiring", note: "Chainlink is the announced oracle partner (reported, launch PR 2026-07-01) — relevant to the Stock oracle hooks (pauseOracle/updateMultiplier) and any price-dependent contract. No feed addresses verified here — resolve on-chain before use. On-chain DEX pool price ≠ official equity quote around US market open/close (basis risk)." },
      { title: "What's actually deployed (on-chain vs reported)", command: "UniswapV3Factory 0x1f7d7550b1b028f7571e69a784071f0205fd2efa (Blockscout is_verified, solc 0.7.6) ← NPM 0x73991a25C818Bf1f1128dEAaB1492D45638DE0D3.factory() cross-verified; Multicall3 + Permit2 at canonical addresses", note: "VERIFIED on-chain: Uniswap v3 (non-canonical addresses — resolve via getters), Sherwood Protocol (native DeFi, WOOD token), Maple syrupUSDG. REPORTED day-one, not address-verified: 1inch, Lighter, Arcus. Data layer: Blockscout keyless (/api/v2/tokens, /stats, /smart-contracts/{addr}) + raw PoolCreated logs — dedicated indexers still lag this chain (onchain_data_indexing)." },
    ],
    warnings: [
      "Stock tokens are upgradeable, pausable, clawback-capable (adminBurn) issuer contracts behind a SHARED beacon — one upgrade changes all of them. The UI multiplier means raw balanceOf silently diverges from the real share count after a split. Never treat them as trustless plain ERC-20s.",
      "Fee-model reads fluctuate: one getPricesInWei/getL1BaseFeeEstimate read showed all L1 components at 0, the next showed them nonzero. Measure at runtime, never hardcode. The chain is weeks old — re-verify addresses/liquidity via getters before committing capital.",
    ],
    references: ["https://docs.robinhood.com/chain/deploy-smart-contracts", "https://docs.robinhood.com/chain/contracts", "https://robinhoodchain.blockscout.com"],
  },
};
